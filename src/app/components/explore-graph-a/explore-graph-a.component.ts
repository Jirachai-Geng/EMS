 ...
 */
 @Component({
  selector: 'app-explore-graph-a',
  templateUrl: './explore-graph-a.component.html',
  styleUrls: ['./explore-graph-a.component.scss']
})
export class ExploreGraphAComponent  {
  ...
  todoItemSelectionToggle(node: TodoItemFlatNode): void {
    ...
    this.temp = this.checklistSelection.selected
